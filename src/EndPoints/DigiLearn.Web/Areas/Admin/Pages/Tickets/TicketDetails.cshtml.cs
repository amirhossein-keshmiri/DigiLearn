...
{
  public class TicketDetailsModel : BaseRazor
  {
    private readonly ITicketService _ticketService;
    public readonly IUserFacade _userFacade;
    public TicketDetailsModel(ITicketService ticketService, IUserFacade userFacade)
    {
    ...
    public async Task<IActionResult> OnPost(Guid id)
    {
      ...
      return RedirectAndShowAlert(result, RedirectToPage("TicketDetails", new { id }));
    }
